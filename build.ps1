...
elseif ($RunTests -And $CheckCoverage) {
	...
	OpenCover.Console.exe -register:user -target:"%LocalAppData%\Microsoft\dotnet\dotnet.exe" -targetargs:"test tests/TurnerSoftware.RobotsExclusionTools.Tests/TurnerSoftware.RobotsExclusionTools.Tests.csproj /p:DebugType=Full" -filter:"+[TurnerSoftware.RobotsExclusionTools]* -[TurnerSoftware.RobotsExclusionTools.Tests]*" -output:"$packageOutputFolder\coverage.xml" -oldstyle
